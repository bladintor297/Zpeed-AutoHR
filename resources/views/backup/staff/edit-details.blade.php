...
@section('content')
<div class="container">
    <p class="text-center fs-6 mt-2 fs-1 fw-bold">Staffs Details<br></p>
    <div class="row justify-content-center">
        <div class="col-md-3">
            ...
            <div class="card mt-2 overflow-auto" style="height: 19em" >
                <h5 class="mb-2 border-bottom fw-bold me-5 ms-2 mt-3">Certificates <button data-bs-target="#cert{{$staff->staff_id}}" data-bs-toggle="modal" class="badge bg-primary fw-bold mb-1">+</button></h5>
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body scroll">
                    <h5 class="mb-2 border-bottom fw-bold">Personal Details</h5>
                    {!! Form::open(['action' => ['\App\Http\Controllers\StaffController@update', $staff->staff_id], 'method'=>'POST']) !!}
                    <div class="row g-3">
                        <div class="form-group col-md-4 mt-3" >
                            {{Form::label('name', 'Full Name')}}
                            {{Form::text('name', $staff->name, ['class' => 'form-control','placeholder' => 'Enter staff full name...'])}}
                        </div>
                        <div class="form-group col-md-3 mt-3" >
                            {{Form::label('nric', 'NRIC (without "-")')}}
                            {{Form::text('nric', $staff->nric, ['class' => 'form-control', 'placeholder' => 'Enter staff NRIC number...', 'maxlength' => '12'])}}
                        </div>
                    ...
                    <div class="row g-2 mt-0">
                        <div class="form-group col-md-2 " >
                            ...
                            {{Form::select('marry', ['1' => 'Single', '2' => 'Married', '3' => 'Divorced'], null, 
                        ...
                        <div class="form-group col-md-2 " >
                            ...
                            {{Form::text('phone', $staff->phone, ['class' => 'form-control', 'placeholder' => 'Enter staff phone number...'])}}
                        </div>
                        <div class="form-group col-md-3 " >
                            {{Form::label('start_date', 'Start Date')}}
                            {{Form::date('start_date', $staff->start_date, ['class'=> 'form-control', 'required']);}}
                        </div>

                        <div class="form-group col-md-3 " >
                            {{Form::label('status', 'Employment Status')}}
                            {{Form::select('status', ['0'=> 'On Probation', '1' => 'Permanent', '2' => 'Resigned'], $staff->status, ['class'=> 'form-select', 'id' => 'inputGroupSelect01']);}}
                        </div>
                    </div>
                    <div class="row g-2 mt-0">
                        <div class="form-group col-md-3 " >
                            {{Form::label('designation', 'Designation')}}
                            {{Form::text('designation', $staff->designation, ['class' => 'form-control'])}}
                        </div>
                        <div class="form-group col-md-3 " >
                            {{Form::label('role', 'Role')}}
                            {{Form::select('role', ['3'=> 'Regular Staff', '2' => 'Supervisor', '1' => 'System Admin'], $staff->role, ['class'=> 'form-select', 'id' => 'inputGroupSelect01']);}}
                        </div>
                        <div class="form-group col-md-4 " >
                            {{Form::label('supervisor', 'Supervisor')}}
                            <select id="supervisor" name="supervisor" class="form-select" value="{{$staff->supervisor}}">
                        ...
                        <div class="form-group col-md-2 " >
                            ...
                            {{Form::text('epf', $staff->epf, ['class' => 'form-control'])}}
                        </div>
                    </div>
                    ...
                    <div class="row g-2 mt-0 mb-3">
                        ...
                        <div class="form-group col-md-4 " >
                            ...
                            {{Form::text('bank_acc', $staff->bank_acc, ['class' => 'form-control'])}}
                        </div> 
                        <div class="form-group col-md-3 " >
                            ...
                            {{Form::text('tax', $staff->income_tax, ['class' => 'form-control'])}}
                        </div>                        
                    </div>
                    ...
                    <div class="row g-2 mt-0 mb-3">
                        <div class="form-group col-md-6 " >
                            ...
                            {{Form::text('qualification', $staff->qualification, ['class' => 'form-control'])}}
                        </div>
                        <div class="form-group col-md-4 " >
                            {{Form::label('university', 'University')}}
                            {{Form::text('university', $staff->university, ['class' => 'form-control'])}}
                        </div>
                        <div class="form-group col-md-2 " >
                            {{Form::label('year', 'Grad Year')}}
                            {{Form::text('year', $staff->year, ['class' => 'form-control'])}}
                        </div>
                    </div>
                    ...
                    <div class="row g-2 mt-0 mb-3">
                        ...
                        <div class="form-group col-md-6 " >
                            ...
                            {{Form::number('al', $staff->ent_al, ['class' => 'form-control', 'min' => '0'])}}
                        </div>
                        <div class="form-group col-md-6 " >
                            {{Form::label('ml', 'Medical Leave')}}
                            {{Form::number('ml', $staff->ent_ml, ['class' => 'form-control'])}}
                        </div>
                    </div>
                    <input type="hidden" name="staff_id" value="{{$staff->staff_id}}">
                        <div class="d-grid gap-2 col-md-12 mx-auto">
                            {{Form::hidden('_method','PUT')}}
                            {{Form::submit('Update Profile', ['class'=>'btn btn-primary fw-bold'])}}
                        </div>
                    {!! Form::close() !!}
                </div>
            </div>
