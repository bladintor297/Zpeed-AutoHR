            ...
            @if(count($claims)>0)
                ...
                @if(count($milleages)>0)
                    ...
                    <tr class="text-dark text-start">
                        ...
                        <td  class="text-center"><span class="text-primary">{{$claim->distance}}km</span></td>
                        <td  class="text-end" >RM {{number_format((float)$claim->total, 2, '.', '')}}</td>
                    </tr>
                    @endforeach
                @endif
                <tr class="text-dark text-start">
                ...
                @if(count($parkings)>0)
                    ...
                    <tr class="text-dark text-start">
                        ...
                        <td> &nbsp;&nbsp;&nbsp;&nbsp;{{$claim->detail}}</td>
                        @if ($claim->receipt !== '')
                        <td  class="text-center"><span class="badge bg-success fw-bold">YES</span></td>
                        @else
                        <td  class="text-center"><span class="badge bg-danger fw-bold">NO</span></td>
                        @endif
